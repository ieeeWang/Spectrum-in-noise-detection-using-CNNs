# -*- coding: utf-8 -*-
"""
Created on Sun Jun  7 19:44:11 2020
tf.keras.losses.mean_squared_error(y, y_)
@author: lwang
"""
...
import time
from generate_images_v1 import prepare_dataset
...
def loss(model, x, y):
    y_ = model(x)
    batch_loss = tf.keras.losses.mean_squared_error(y, y_)#better first initial a object
